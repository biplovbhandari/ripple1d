...
::: ripple1d.ops.ras_terrain.create_ras_terrain

## Terrain Agreement

Terrain agreement metrics are written to either a json file with suffix ".terrain_agreement.json" or a sqlite database with suffix ".terrain_agreement.db" in the model directory.
The json will have the following schema:
